...
export async function generateMetadata() {
  return {
    title: 'Organizer Panel - GDG Hackathon Hub',
    description: 'Manage hackathon and assign judges',
  };
}

const OrganizerPanelPage = async () => {
    ...
    <DashboardLayout userRole={userRole}>
      ...
      <div className="mb-8 grid gap-6 md:grid-cols-4">
        <div className="rounded-xl border border-border bg-[#c3ecf6] p-6 dark:from-blue-950 dark:to-blue-900">
          ...
          <h3 className="mt-2 text-3xl font-bold text-[#4285f4] dark:text-blue-100">0</h3>
        </div>
        <div className="rounded-xl border border-border bg-[#ccf6c5] p-6 dark:from-green-950 dark:to-green-900">
          ...
          <h3 className="mt-2 text-3xl font-bold text-[#34a853] dark:text-green-100">0</h3>
        </div>
        <div className="rounded-xl border border-border bg-[#ffe7a5] p-6 dark:from-yellow-950 dark:to-yellow-900">
          ...
          <h3 className="mt-2 text-3xl font-bold text-[#f9ab00] dark:text-yellow-100">0</h3>
        </div>
        <div className="rounded-xl border border-border bg-[#f8d8d8] p-6 dark:from-red-950 dark:to-red-900">
          ...
          <h3 className="mt-2 text-3xl font-bold text-[#ea4335] dark:text-red-100">0</h3>
        </div>
      </div>
